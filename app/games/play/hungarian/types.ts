...
export const ORDERS: Order[] = [
  { id: 1, restX: -5, restZ: -14, custX: 12, custZ: 4, color: '#FFD93D', restaurant: 'פיצה רומא', family: 'משפחת כהן' },
  { id: 2, restX: 26, restZ: 16, custX: -26, custZ: 24, color: '#6BCF7F', restaurant: 'סושי טוקיו', family: 'משפחת לוי' },
  { id: 3, restX: -4, restZ: 20, custX: 30, custZ: -6, color: '#B4A7D6', restaurant: 'בורגר האוס', family: 'משפחת אברהם' },
